require 'empty_positions_finder'

RSpec.describe EmptyPositionsFinder do
  describe '.call' do
    subject(:result) { described_class.call(board) }
    ...
    it 'Returns correct empty_positions array' do
      expect(result).to eq(empty_positions)
    end
  end
end
